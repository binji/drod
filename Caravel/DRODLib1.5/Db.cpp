...
//Returns: the current player ID.  If it is zero, try to find the first local ID.
{
	if (!dwCurrentPlayerID)
	{
		...
		if (pPlayer)
		{
			//!!Add: player remember me option.
			dwCurrentPlayerID = pPlayer->dwPlayerID;
			delete pPlayer;
		}
	}
	return dwCurrentPlayerID;
}
...
//*****************************************************************************
MESSAGE_ID CDb::ImportFromFile(
//Imports an XML file into the DB.
//
//Params:
	const char *pszFilepath)
{
	return CDbXML::ImportXML(pszFilepath);
}
