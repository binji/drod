...
//View definitions.
DEFTDEF(HOLD_INCREMENTEDIDS_VIEWDEF,
		"IncrementedIDs"
      "["
			"DemoID:I,"
			"LevelID:I,"
...
DEFTDEF(PLAYER_INCREMENTEDIDS_VIEWDEF,
		"IncrementedIDs"
      "["
			"PlayerID:I"
		"]");

DEFTDEF(TEXT_INCREMENTEDIDS_VIEWDEF,
		"IncrementedIDs"
      "["
			"MessageID:I,"
			"MessageTextID:I"
...
= {
   ...
   "ExploredRooms", "GID_Created", "GID_LevelIndex",
	"GID_NewLevelIndex", "GID_OriginalNameMessage", "GID_PlayerID",
	"HoldID", "IsFirstTurn", "IsHidden", "IsLocal", "IsRequired",
	"LanguageCode", "LastUpdated", "Left", "LevelID",
	"ExtraVars", "Message", "MessageText", "MessageTextID",
	"NameMessage", "NextDemoID", "O", "PlayerID",
	"ProcessSequence", "Right", "RoomID", "RoomCols",
	"RoomRows", "RoomX", "RoomY", "SavedGameID",
...
// $Log: DBProps.h,v $
// Revision 1.25  2004/07/18 13:31:31  gjj
...
// bugfixes, etc.
//
// Revision 1.24  2003/07/24 20:33:19  mrimer
// Tweaking the viewdef's text layout.
//
// Revision 1.23  2003/07/19 02:31:16  mrimer
// Added EndHoldMessage(ID) prop.
//
// Revision 1.22  2003/06/27 19:02:25  mrimer
// Added a missing comma.
//
// Revision 1.21  2003/06/27 17:27:32  mrimer
// Added hold editing privilege data.
//
// Revision 1.20  2003/06/26 17:23:21  mrimer
// Removed old ExitLevelID tag.
//
// Revision 1.19  2003/05/08 23:17:36  erikh2000
// Revised for v1.6 db format.
// Fixed extra comma errors.
//
// Revision 1.18  2003/04/17 20:53:13  mrimer
// Removed Level's RoomsNeededToComplete prop and added Room's IsRequired prop.
//
