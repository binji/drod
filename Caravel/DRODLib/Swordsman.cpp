...
{
	this->wX = this->wY = this->wPrevX = this->wPrevY = this->wO =
         this->wSwordX = this->wSwordY = 0;
	this->bIsPlacingMimic = this->bIsDying = false;
...
// $Log: Swordsman.cpp,v $
// Revision 1.6  2003/08/07 16:07:56  mrimer
// Added bIsDying flag.
//
// Revision 1.5  2003/06/22 05:57:27  mrimer
// Fixed a bug.
//
// Revision 1.4  2003/05/23 21:30:37  mrimer
// Altered the #includes for files from BackEndLib (from "file.h" to <file.h>).
//
// Revision 1.3  2003/05/22 23:39:02  mrimer
