...
public:
   ...
   WSTRING  AbbrevRoomLocation();
	...
	bool		IsCurrentRoomPendingExit(void) const;
...
private:
   ...
   void     LoadNewRoomForExit(const DWORD dwNewSX, const DWORD dwNewSY,
         CDbRoom* pNewRoom, CCueEvents &CueEvents);
   ...
   bool     SwordsmanCanExitRoom(const UINT wDirection, DWORD &dwNewSX,
         DWORD &dwNewSY, CDbRoom* &pNewRoom);
	bool		WasRoomConqueredOnThisVisit(void) const;
	DWORD		WriteCurrentRoomDemo(DEMO_REC_INFO &dri, const bool bHidden=false,
...
// $Log: CurrentGame.h,v $
// Revision 1.81  2003/08/23 15:25:33  mrimer
...
//
// Revision 1.72  2003/04/06 03:57:00  schik
// Ported to SGI.
